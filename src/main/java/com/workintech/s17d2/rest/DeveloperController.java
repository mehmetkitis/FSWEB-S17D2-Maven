...
public class DeveloperController {
    ...
    public void init(){
        ...
        this.developers.put(1,new JuniorDeveloper(1,"mehmet",40000d));
    }
    ...
    public DeveloperResponse save(@RequestBody Developer developer){
        ...
        return new DeveloperResponse(createdDeveloper,HttpStatus.CREATED.value(),
    ...
    public DeveloperResponse getById(@PathVariable("id") int id){
        ...
        if (foundDeveloper == null){
            return new DeveloperResponse(foundDeveloper,HttpStatus.NOT_FOUND.value(),
    ...
    public DeveloperResponse delete(@PathVariable("id") int id){
        ...
        return new DeveloperResponse(removedDeveloper,HttpStatus.NO_CONTENT.value(),
                "silme başarılı");
    }
}
